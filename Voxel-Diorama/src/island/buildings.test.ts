...
const tasks = [
  { id: "trip-root", parentId: null, status: "done", priority: "medium" },
  { id: "issue-b", parentId: "trip-root", status: "done", priority: "critical" },
  { id: "issue-a", parentId: "trip-root", status: "done", priority: "low" },
  { id: "pending", parentId: "trip-root", status: "in_review", priority: "high" },
  { id: "grandchild", parentId: "issue-a", status: "done", priority: "high" },
  { id: "other-trip", parentId: "another-root", status: "done", priority: "high" },
] as const;
...
assert.deepEqual(buildings.map(({ score }) => score), [15, 60]);
