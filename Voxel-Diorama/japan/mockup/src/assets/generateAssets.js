'use strict';
// Asset generator: renders every manifest entry to a transparent PNG in
// /assets, plus assets/meta.js (sprite anchors for the renderer) and
// assets/contact-sheet.html (visual QA). Run: node src/assets/generateAssets.js
...
<style>
  ...
  img { image-rendering: pixelated; max-width: 160px; }
...
function main() {
  ...
  for (const entry of ASSET_MANIFEST) {
    ...
    if (model.kind === 'ui') {
      ...
      sprite = renderSprite({ id: entry.id, ...model });
  ...
  // sprite anchors for the browser renderer (classic script tag, no fetch)
